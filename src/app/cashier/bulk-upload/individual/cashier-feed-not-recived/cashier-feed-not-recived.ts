...
@Component({
  selector: 'app-cashier-feed-not-recived',
  imports: [DynamicForm, Dynamictable],
  templateUrl: './cashier-feed-not-recived.html',
  styleUrl: './cashier-feed-not-recived.css',
})
export class CashierFeedNotRecived {
 mainForm!: FormGroup
