...
@Component({
  selector: 'app-renewal-cda-charges',
  imports: [DynamicDataTable],
  templateUrl: './renewal-cda-charges.html',
  styleUrl: './renewal-cda-charges.css',
})
export class RenewalCdaCharges {

    renewalCDARows: DynamicDataTableModal[] = [
      {
        label: 'Premim Due',
        type: 'text',
