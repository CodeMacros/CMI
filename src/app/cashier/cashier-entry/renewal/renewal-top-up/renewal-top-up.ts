...
@Component({
  selector: 'app-renewal-top-up',
  imports: [DynamicDataTable],
  templateUrl: './renewal-top-up.html',
  styleUrl: './renewal-top-up.css',
})
export class RenewalTopUp {

    topUpRows: DynamicDataTableModal[] = [
      {
        label: 'Premim Due',
        type: 'text',
